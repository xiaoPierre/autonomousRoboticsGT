...
class JointSetStateData {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = std_msgs.msg.UInt8MultiArray.serialize(obj.setModes, bufferInfo);
    // Serialize message field [values]
    bufferInfo = std_msgs.msg.Float32MultiArray.serialize(obj.values, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new JointSetStateData();
    ...
    tmp = std_msgs.msg.UInt8MultiArray.deserialize(buffer);
    data.setModes = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [values]
    tmp = std_msgs.msg.Float32MultiArray.deserialize(buffer);
    data.values = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
      buffer: buffer
